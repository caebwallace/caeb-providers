...
const formatTickerInfo = asset => {
    return {
        ...
        pricePrecision: numbers_1.nz(numbers_1.countDecimals(parseFloat(asset.baseIncrement)), 8),
        quotePrecision: numbers_1.nz(numbers_1.countDecimals(parseFloat(asset.quoteIncrement)), 8),
        minPrice: numbers_1.nz(parseFloat(asset.baseMinSize), 0),
        maxPrice: numbers_1.nz(parseFloat(asset.baseMaxSize), 0),
        minQty: numbers_1.nz(parseFloat(asset.baseMinSize), 0),
        stepSize: numbers_1.nz(parseFloat(asset.baseIncrement), 0),
