...
class ProviderKucoin extends index_1.ProviderCommon {
    constructor(props) {
        super();
        this.name = 'kucoin';
        this.id = 'kucoin';
    ...
    getExchangeInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return symbols.map(symbol => formatTickerInfo_1.formatTickerInfo(symbol));
        });
    }
    ...
    __getAllOrders(baseAsset, quoteAsset, status = 'done', tradeType = 'TRADE', daysRange = 365) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.respectApiRatioLimits();
            const tickerInfo = yield this.getTickerInfo(baseAsset, quoteAsset);
            const symbol = this.formatSymbol(baseAsset, quoteAsset);
    ...
    __getAllOrdersRequest(obj) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((_a = req === null || req === void 0 ? void 0 : req.data) === null || _a === void 0 ? void 0 : _a.items) {
