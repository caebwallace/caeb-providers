...
const formatOrder = (order, tickerInfo) => {
    const price = (0, numbers_1.roundToFloor)((0, numbers_1.nz)(order.price || order.avgFillPrice, 0), tickerInfo.quotePrecision);
    const side = order.side === 'buy' ? interfaces_1.OrderSide.BUY : interfaces_1.OrderSide.SELL;
    const origQty = (0, numbers_1.roundToFloor)((0, numbers_1.nz)(order.size, 0), tickerInfo.pricePrecision);
    const executedQty = (0, numbers_1.roundToFloor)((0, numbers_1.nz)(order.filledSize, 0), tickerInfo.pricePrecision);
    const origQuoteOrderQty = (0, numbers_1.roundToFloor)((0, numbers_1.nz)(price * origQty, 0), tickerInfo.quotePrecision);
    const cummulativeQuoteQty = (0, numbers_1.roundToFloor)((0, numbers_1.nz)(price * executedQty, 0), tickerInfo.quotePrecision);
