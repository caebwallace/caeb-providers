...
`,
            ...
            (t.stemmer = (function () {
                var e = {
                    ...
                    N = function (c) {
                        ...
                        return (
                            (d = U), (x = v), d.test(c) && x.test(c) && ((d = S), (c = c.replace(d, ''))), T == 'y' && (c = T.toLowerCase() + c.substr(1)), c
                        );
                    };
                return function (M) {
                    return M.update(N);
            ...
            (t.Index = function (e) {
                ...
                (t.Index.load = function (e) {
                    ...
                    return (
                        a.finish(), (n.fields = e.fields), (n.fieldVectors = r), (n.invertedIndex = s), (n.tokenSet = a.root), (n.pipeline = u), new t.Index(n)
                    );
                });
            (t.Builder = function () {
                (this._ref = 'id'),
    ...
    var re = class extends J {
            ...
            hideShowToolbar() {
                ...
                (this.showToolbar = this.lastY >= this.scrollTop || this.scrollTop <= 0 || (!!this.searchInput && this.searchInput === document.activeElement)),
                    n !== this.showToolbar && (this.toolbar.classList.toggle('tsd-page-toolbar--hide'), this.navigation?.classList.toggle('col-menu--hide')),
    ...
    function Fe(t, e, n, r) {
        ...
        n.addEventListener('keydown', s => {
            (i = !0), s.key == 'Enter' ? Ve(e, n) : s.key == 'Escape' ? n.blur() : s.key == 'ArrowUp' ? fe(e, -1) : s.key === 'ArrowDown' ? fe(e, 1) : (i = !1);
        }),
